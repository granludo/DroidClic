...
public class CustomAdapter extends CursorAdapter {
	...
	public void bindView(final View view, final Context context,
		...
		String iconName = cursor.getString(cursor
				.getColumnIndexOrThrow("nombre")) + ".ico";
				...
				if (Descompressor.descompressor(CO.fitxer, CO.path)) {
					...
					if (Parser.getActivitats().size() == 0) {
						Dialog noActivitats = new AlertDialog.Builder(context)
								...
								.setMessage(
										"No hi ha activitats o les que hi ha no són vàlides!")
								.create();
						noActivitats.show();
					} else {
					...
					Dialog noActivitats = new AlertDialog.Builder(context)
							...
							.setPositiveButton("D'acord", null)
							.setMessage("El fitxer no és vàlid!").create();
					noActivitats.show();
				}
