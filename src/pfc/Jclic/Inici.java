...
public class Inici extends Activity {
	...
	public static File jclicDir = new File(
			Environment.getExternalStorageDirectory(), "JClic");
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// TODO: nomes s'omple la llista en crear lactivitat, esto esta MAAL,
		// perque al tornar surt la llista buida!
