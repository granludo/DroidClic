...
public class Parser {
	...
	private static void parserDoc(Document doc) {
		try {
			...
			String title = projecte.getChild(XMLConstants.SETTINGS)
					.getChildText(XMLConstants.TITLE);
			String author = projecte.getChild(XMLConstants.SETTINGS)
					.getChild(XMLConstants.AUTHOR)
					.getAttributeValue(XMLConstants.NAME);
			String language = projecte.getChild(XMLConstants.SETTINGS)
					.getChildText(XMLConstants.LANGUAGE);
			String description = projecte.getChild(XMLConstants.SETTINGS)
					.getChild(XMLConstants.DESCRIPTION)
					.getChildText(XMLConstants.P);
			String keywords = projecte.getChild(XMLConstants.SETTINGS)
					.getChildText(XMLConstants.DESCRIPTORS);
			String category = projecte.getChild(XMLConstants.SETTINGS)
					.getChild(XMLConstants.DESCRIPTORS)
					.getAttributeValue(XMLConstants.AREA);
			String age = projecte.getChild(XMLConstants.SETTINGS)
					.getChild(XMLConstants.DESCRIPTORS)
					.getAttributeValue(XMLConstants.LEVEL);
